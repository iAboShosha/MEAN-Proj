...
export Intermediate, {schema} from './model'
...
/**
 * @api {get} /intermediates Retrieve intermediate users
 * @apiName Retrieveintermediates
 * @apiGroup intermediate
 * @apiPermission admin
 * @apiParam {String} access_token User access_token.
 * @apiUse listParams
 * @apiSuccess {Object[]} users List of intermediates.
...
/**
 * @api {get} /intermediates/:id Retrieve intermediate
 * @apiName Retrieveintermediate
 * @apiGroup intermediate
 * @apiPermission public
 * @apiSuccess {Object} intermediate User's data.
...
/**
 * @api {post} /intermediates Create intermediate
 * @apiName Createintermediate
 * @apiGroup intermediate
...
/**
 * @api {put} /intermediates/:id Update intermediate
 * @apiName Updateintermediate
 * @apiGroup intermediate
 * @apiPermission user
 * @apiParam {String} access_token User access_token.
 * @apiParam {String} [name] User's name.
