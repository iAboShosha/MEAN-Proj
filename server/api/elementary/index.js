...
export Elementary, {schema} from './model'
...
/**
 * @api {get} /elementarys Retrieve elementary users
 * @apiName Retrieveelementarys
 * @apiGroup elementary
 * @apiPermission admin
 * @apiParam {String} access_token User access_token.
 * @apiUse listParams
 * @apiSuccess {Object[]} users List of elementarys.
...
/**
 * @api {get} /elementarys/:id Retrieve elementary
 * @apiName Retrieveelementary
 * @apiGroup elementary
 * @apiPermission public
 * @apiSuccess {Object} elementary User's data.
...
/**
 * @api {post} /elementarys Create elementary
 * @apiName Createelementary
 * @apiGroup elementary
...
/**
 * @api {put} /elementarys/:id Update elementary
 * @apiName Updateelementary
 * @apiGroup elementary
 * @apiPermission user
 * @apiParam {String} access_token User access_token.
 * @apiParam {String} [name] User's name.
